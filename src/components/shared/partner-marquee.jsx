  ...
  return (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
      <Marquee repeat={100} reverse pauseOnHover className="[--duration:25s] [--gap:3rem]">
        {images?.map((img, idx) => (
          <Image key={idx} src={img?.image} alt={img?.title} width={100} height={100} className=" object-contain grayscale-100 hover:grayscale-0 transition-all duration-300 lg:w-32 w-24  " />
        ))}
      </Marquee>
